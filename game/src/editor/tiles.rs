...
pub static TILES_EDIT: [fx::TileGfx; 45] = [
	...
	fx::TileGfx { sprite: fx::Sprite::PanelNorth, model: fx::Model::Floor }, // Terrain::PanelN
	fx::TileGfx { sprite: fx::Sprite::PanelWest, model: fx::Model::Floor }, // Terrain::PanelW
	fx::TileGfx { sprite: fx::Sprite::PanelSouth, model: fx::Model::Floor }, // Terrain::PanelS
	fx::TileGfx { sprite: fx::Sprite::PanelEast, model: fx::Model::Floor }, // Terrain::PanelE
	fx::TileGfx { sprite: fx::Sprite::PanelSE, model: fx::Model::Floor }, // Terrain::PanelSE
	fx::TileGfx { sprite: fx::Sprite::HiddenWall, model: fx::Model::Wall }, // Terrain::HiddenWall
	fx::TileGfx { sprite: fx::Sprite::HiddenWall, model: fx::Model::Wall }, // Terrain::HiddenWallRevealed
	fx::TileGfx { sprite: fx::Sprite::InvisWall, model: fx::Model::Wall }, // Terrain::InvisWall
	fx::TileGfx { sprite: fx::Sprite::BlueWall, model: fx::Model::Wall }, // Terrain::BlueWall
	fx::TileGfx { sprite: fx::Sprite::BlueWallFake, model: fx::Model::Wall }, // Terrain::BlueFake
	...
	fx::TileGfx { sprite: fx::Sprite::RecessedWall, model: fx::Model::Floor }, // Terrain::RaisedWall
];
