...
fn draw_floor(cv: &mut shade::d2::DrawBuffer<Vertex, Uniform>, pos: Vec3<f32>, sprite: data::SpriteId, z1: f32, z2: f32, alpha: f32) {
...
fn draw_shadow(cv: &mut shade::d2::DrawBuffer<Vertex, Uniform>, pos: Vec3<f32>, sprite: data::SpriteId, skew: f32, a: f32) {
	let gfx = sprite.index();
...
fn draw_wall(cv: &mut shade::d2::DrawBuffer<Vertex, Uniform>, pos: Vec3<f32>, w: f32, sprite: data::SpriteId, alpha: f32) {
	let gfx = sprite.index();
...
fn draw_portal(cv: &mut shade::d2::DrawBuffer<Vertex, Uniform>, pos: Vec3<f32>, sprite: data::SpriteId) {
	let gfx = sprite.index();
...
pub fn draw(cv: &mut shade::d2::DrawBuffer<Vertex, Uniform>, pos: Vec3<f32>, sprite: data::SpriteId, model: data::ModelId, alpha: f32) {
	match model {
		data::ModelId::Empty => (),
...
pub fn draw_tile(cv: &mut shade::d2::DrawBuffer::<render::Vertex, render::Uniform>, terrain: core::Terrain, pos: Vec3<f32>, tiles: &[TileGfx]) {
...
pub fn field(cv: &mut shade::d2::DrawBuffer::<render::Vertex, render::Uniform>, state: &FxState, time: f32) {
